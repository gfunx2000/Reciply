...
var recipePicture = "1_main.jpg" // Image that is displayed on the first page of Today
var prepTime = 20
var cookTime = 5
...
// Text for each of the steps in Today's Recipe
...
// This array needs to be pulled from the database instead of filled in here.
// Names of the images for Today's Recipe steps
let contentImages = ["1_1", "1_2", "1_3", "1_4", "1_5", "1_6", "1_7", "1_8", "1_9", "1_10", "1_11", "1_12"]

////  There's probably a better way to do this...
// Ingredients for Today's Recipe
var ingredientsForToday = [""]
var ingredientQuantityforToday = [0]
var ingredientUnitsForToday = [""]  // Look into using swift's built in measurements
